;(function(){
	...
	var sketch = function(datas, dataParser, config){
		...
		for(var i = 0; i < datas.length && i < chartSketch.maxDotCount; i++){
			...
			dataSketch.origin.min = Math.min(price, avgPrice, openPrice, closePrice, dataSketch.origin.min);
			dataSketch.origin.max = Math.max(price, avgPrice, openPrice, closePrice, dataSketch.origin.max);

util.loadData(function(datas){
	...
	TradeChart2.KSubChartOperationUtil.addKSubChartOperationSupport(trendOperationCanvasObj, result_trend);
	TradeChart2.KSubChartOperationUtil.addKSubChartOperationSupport(volumeOperationCanvasObj, result_volume);
});
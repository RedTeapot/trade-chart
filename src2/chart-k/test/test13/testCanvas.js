util.loadData(function(datas){
	...
	KSubChartOperationUtil.addKSubChartOperationSupport(trendOperationCanvasObj, result_trend, ops);
	KSubChartOperationUtil.addKSubChartOperationSupport(volumeOperationCanvasObj, result_volume, ops);
});